...
//            Log.e("","3. time: '" + (System.currentTimeMillis() - HttpController.time ));
            HttpController.time = System.currentTimeMillis();
            ...
            String name = (String) mbRequest.get(Constants.IMG_NAME);
...
//            Log.e("","4. time: '" + (System.currentTimeMillis() - HttpController.time ));
            HttpController.time = System.currentTimeMillis();
            HttpController.uploadImage((byte[]) body, url, name);
            return null;
        }
    }
}
