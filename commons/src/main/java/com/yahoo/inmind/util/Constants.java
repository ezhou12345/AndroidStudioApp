...
public final class Constants {
    ...
    public static final String HTTP_REQUEST_PARAMS = "HTTP_REQUEST_PARAMS";
    public static final String HTTP_REQUEST_CONNECTION_TIMEOUT = "HTTP_REQUEST_CONNECTION_TIMEOUT";
