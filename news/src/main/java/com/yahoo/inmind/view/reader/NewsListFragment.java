...
public class NewsListFragment extends I13NFragment implements PluggableAdapterView.PositionChangedListener{
    ...
    int mLayoutId = R.layout.news_fragment_listview;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
        ...
        mPv = (PluggableAdapterView) rootView.findViewById(R.id.news_newslist);
    ...
    private void enableSwipeRefresh(View rootView, PluggableAdapterView av) {
        swipeLayout = (SwipeRefreshLayout) rootView.findViewById(R.id.news_swipe_container);
